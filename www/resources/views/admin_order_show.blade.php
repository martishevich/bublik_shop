		...
		<div class = "row justify-content-center">
			<div class = "col-md-12">
				<div>
					...
					@endif
					@if($order->canCancel())
						<input type = "button" data-status = "cancel" class = "btn btn-danger status_btn"
						       value = "Cancel">
					@endif
					@if($order->canInStore())
						<input type = "button" data-status = "store" class = "btn btn-danger status_btn"
					...
					@if($order->canCollected())
						<input type = "button" data-status = "collected" class = "btn btn-info status_btn"
						       value = "Collected">
					@endif
					@if($order->canWaiting())
						<input type = "button" data-status = "waiting" class = "btn btn-info status_btn"
						       value = "Waiting for delivering">
					@endif
					@if($order->canDelivering())
						<input type = "button" data-status = "delivering" class = "btn btn-info status_btn"
						       value = "Delivering">
					@endif
