...
<div class = "container">
    <div class = "row">
        <div class = "col-md-12 col-lg-12 col-sm-12 col-xs-12 col-12">
            <div class = "info">
                <table class = "table table-sm table-little-font">
                    <tr>
                        <th rowspan = "5"><img src = "images/logo/logo-quadro.png"></th>
                        <td>OOO "Bublik corparation" UNP 191191191</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>OOO "BelarusBank", <b>SWIFT:</b> SOMABY22,<br> <b>IBAN:</b> BYXX SOMA 3XX4 MB00 0002
                            0200
                            0007
                        </td>
                    </tr>
