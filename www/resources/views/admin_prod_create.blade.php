            ...
            <div class = "col-md-12">
                <div>
                    ...
                    <form id = "form-ins" method = "post" action = "/home/products/create">
                        @csrf
                        <p><b>Category:</b></p>
                        <select id = "select-ins" required name="category_id">
                        ...
                        <br>
                        <p><b>Title:</b></p>
                        <input id = "input-ins" type = "text" required name = "name" value = "{{ old('name') }}">
                        <p><b>Price:</b></p>
                        ...
                        <textarea id = "textarea-ins" rows = "4" cols = "100" name = "description" class = "message" required>{{ old('description') }}</textarea>
                        <br>
                        <p><b>Short description:</b></p>
                        <textarea id = "textarea-ins" rows = "2" cols = "50" name = "short_disc" class = "message" required>{{ old('short_disc') }}</textarea>
                        <br>
